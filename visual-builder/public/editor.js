...
const inputs = {
    ...
    textAlign: document.getElementById('alignInput'),
    color: document.getElementById('colorInput'),
    backgroundColor: document.getElementById('bgInput'),
};
iframe.onload = () => {
...
Object.keys(inputs).forEach(key => {
    ...
    input.addEventListener('input', (e) => {
        ...
        const el = (_a = iframe.contentDocument) === null || _a === void 0 ? void 0 : _a.querySelector(`[data-editor-id="${selectedId}"]`);
        if (el) {
...
function startDrag(realEl, id, startEvent) {
    ...
    const onMove = (ev) => {
        ...
        if (isDragging && ghost && indicator) {
            ...
            const elBelow = (_a = iframe.contentDocument) === null || _a === void 0 ? void 0 : _a.elementFromPoint(lookX, lookY);
            ghost.style.display = 'block';
            if (elBelow) {
                const targetEl = elBelow.closest('[data-editor-id]');
    ...
    const onUp = () => {
        ...
        if (isDragging) {
            ...
            if (dropTarget) {
                ...
                }).then(() => { var _a; return (_a = iframe.contentWindow) === null || _a === void 0 ? void 0 : _a.location.reload(); });
            }
        }
    };
...
function showLine(x, y, w, indicator) {
